...
* More Simple Values ([slides](https://clojurebridge-minneapolis.github.io/slides/module2.html), [chat](web-app-notes.md#say-hello-to-yourself), [walk-through](outline/simple_values2.md), lightening talk)
...
* Data Structures ([slides](https://clojurebridge-minneapolis.github.io/slides/module3.html), [chat](web-app-notes.md#write-some-html-with-hiccup), [walk-through](outline/data_structures.md), lightening talk)
...
* Functions ([slides](https://clojurebridge-minneapolis.github.io/slides/module4.html), [chat](web-app-notes.md#add-a-form), [walk-through](outline/functions.md), lightening talk)
...
* Flow Control ([slides](https://clojurebridge-minneapolis.github.io/slides/module5.html), [chat 1](web-app-notes.md#add-some-flow-control), [chat 2](web-app-notes.md#simplify-things-with-let), [walk-through](outline/flow_control.md), lightening talk)
...
* More Functions ([slides](https://clojurebridge-minneapolis.github.io/slides/module7.html), [chat 1](web-app-notes.md#store-and-display-messages), [chat 2](web-app-notes.md#make-it-pretty-by-adding-bootstrap), [walk-through](outline/functions2.md), lightening talk: Parallelism in Clojure - Nic McPhee)
